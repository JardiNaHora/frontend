...
const mapStyles = [
  {
    featureType: "transit",
    elementType: "all",
    stylers: [{ visibility: "off" }], // mudar pra 'on' mostra as estações de metrô
  },
  {
    featureType: "poi",
    elementType: "labels",
...
export const Home = () => {
  ...
  const [origin, setOrigin] = useState(ifce);
  ...
  const { isLoaded, loadError } = useLoadScript({
    googleMapsApiKey: "AIzaSyCPqvnR4YaH1ZWrMw0aA6ogboIULyJYX7w",
    libraries,
  });
  ...
  return (
    <div>
      <h1>Bem vindo: {userLogado.displayName.split(" ")[0]}</h1>
